...
internal class CategoryData : IInitialData
{
    ...
    public IEnumerable<object> GetData()
        => new List<Category>
        {
            ...
            new("SUV", "SUV available for rent from us are comfortable and perfect for all road conditions Diversity of SUV models at very reasonable prices. You can order delivery of SUV directly to address chosen by you or rent from some of our offices in Bulgaria. The SUV vehicles available for hire from us are from the leading world manufacturers as: Volkswagen, Nissan, Renault and others. They offer wonderful combination of comfort and style. We offer affordable prices for hiring SUV. These car group has many extras and all cars are extremely comfortable for driving in urban and non-urban conditions."),
